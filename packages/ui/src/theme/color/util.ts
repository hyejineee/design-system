...
// import type { HexColorType, PrimitiveColor } from './color.type';
...
// export const getPaletteColor = (colorToken: string, palettes: PrimitiveColor) => {
...
//   const isPaletteKey = (key: string): key is keyof PrimitiveColor => {
